...
F.displayName = "AssistantIcon";
const E = o(() => /* @__PURE__ */ e(
  "svg",
  {
    viewBox: "0 0 12 14",
    xmlns: "http://www.w3.org/2000/svg",
...
E.displayName = "AttachmentIcon";
const Y = o(() => /* @__PURE__ */ e(
  "svg",
  {
    viewBox: "0 0 24 24",
    xmlns: "http://www.w3.org/2000/svg",
...
V.displayName = "ExpandIcon";
const A = o(() => /* @__PURE__ */ e(
  "svg",
  {
    viewBox: "0 0 12 14",
    xmlns: "http://www.w3.org/2000/svg",
...
R.displayName = "ChatButton";
const e1 = (t) => new Date(t).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }), W = o((t) => {
  const { messages: n } = t, C = I(null);
  return j(() => {
    var s;
    (s = C.current) == null || s.scrollIntoView({ behavior: "smooth" });
  }, [n]), n.length === 0 ? /* @__PURE__ */ e("div", { className: "elitea-assistant-empty", children: "Send a message to start a conversation" }) : /* @__PURE__ */ r("div", { className: "elitea-assistant-messages", children: [
    n.map((s) => /* @__PURE__ */ r(
      "div",
      {
        className: `elitea-assistant-message-wrapper elitea-assistant-message-wrapper--${s.role}`,
        children: [
          /* @__PURE__ */ r("div", { className: `elitea-assistant-message-meta elitea-assistant-message-meta--${s.role}`, children: [
            s.role === "assistant" && /* @__PURE__ */ e("span", { className: "elitea-assistant-message-avatar elitea-assistant-message-avatar--assistant", children: /* @__PURE__ */ e(F, {}) }),
            /* @__PURE__ */ e("span", { className: "elitea-assistant-message-time", children: e1(s.timestamp) }),
            s.role === "user" && /* @__PURE__ */ e("span", { className: "elitea-assistant-message-avatar elitea-assistant-message-avatar--user", children: /* @__PURE__ */ e(D, {}) })
          ] }),
          /* @__PURE__ */ e("div", { className: `elitea-assistant-message elitea-assistant-message--${s.role}`, children: s.content })
        ]
      },
      s.id
    )),
...
const U = o((t) => {
  const { content: n, children: C, placement: s = "top" } = t, i = I(null), d = I(null), [g, L] = y(!1), [w, v] = y(!1), [p, c] = y({ top: 0, left: 0 }), u = z(() => {
    const l = i.current, f = d.current;
    if (!l || !f) return;
    const h = l.getBoundingClientRect(), x = f.getBoundingClientRect();
    let B;
    s === "top" ? B = h.top - x.height - 8 : B = h.bottom + 8;
    let m = h.left + h.width / 2 - x.width / 2;
    const a = 8;
    m < a && (m = a), m + x.width > window.innerWidth - a && (m = window.innerWidth - a - x.width), B < a && (B = h.bottom + 8), c({ top: B, left: m }), v(!0);
  }, [s]);
  return q(() => {
    g && d.current && u(), g || v(!1);
  }, [g, u]), /* @__PURE__ */ r(_, { children: [
    /* @__PURE__ */ e(
      "div",
      {
        ref: i,
...
const P = o((t) => {
  const { placeholder: n, text: C, onTextChange: s, files: i, onFilesChange: d, onSend: g, expanded: L } = t, w = I(null), [v, p] = y(0), c = () => {
    const a = C.trim();
    !a && i.length === 0 || (g(a, i.length > 0 ? i : void 0), s(""), d([]));
  }, u = (a) => {
    a.key === "Enter" && !a.shiftKey && (a.preventDefault(), c());
  }, l = () => {
    var a;
    (a = w.current) == null || a.click();
  }, f = (a) => {
    const k = a.target.files;
    k && d([...i, ...Array.from(k)]), p((N) => N + 1);
  }, h = (a) => {
    d(i.filter((k, N) => N !== a));
  }, x = L ? 3 : 2, B = i.slice(0, x), m = i.length - x;
  return /* @__PURE__ */ r("div", { className: "elitea-assistant-input-area", children: [
    i.length > 0 && /* @__PURE__ */ r("div", { className: "elitea-assistant-file-list", children: [
      B.map((a, k) => /* @__PURE__ */ e(
        U,
        {
          content: a.name,
          children: /* @__PURE__ */ r("div", { className: "elitea-assistant-file-chip", children: [
            /* @__PURE__ */ e("span", { className: "elitea-assistant-file-chip-icon", children: /* @__PURE__ */ e(A, {}) }),
      ...
      m > 0 && /* @__PURE__ */ r("div", { className: "elitea-assistant-file-chip elitea-assistant-file-chip--count", children: [
        "+",
        m
      ] })
    ] }),
    /* @__PURE__ */ r("div", { className: "elitea-assistant-input-row", children: [
      /* @__PURE__ */ e(
        "input",
        {
          ref: w,
...
const $ = o((t) => {
  const {
    ...
    onExpand: u,
    expanded: l
  } = t, f = /* @__PURE__ */ r("div", { className: `elitea-assistant-window${l ? " elitea-assistant-window--expanded" : ""}`, children: [
    /* @__PURE__ */ r("div", { className: "elitea-assistant-header", children: [
      /* @__PURE__ */ r("div", { className: "elitea-assistant-header-left", children: [
        /* @__PURE__ */ e(
          "button",
          {
        ...
        /* @__PURE__ */ e("h2", { className: "elitea-assistant-header-title", children: n })
      ] }),
      /* @__PURE__ */ r("div", { className: "elitea-assistant-header-right", children: [
        /* @__PURE__ */ e(
          "button",
          {
  ...
  return l ? /* @__PURE__ */ e(
    "div",
    {
      ...
      onClick: u,
      children: /* @__PURE__ */ e("div", { onClick: (h) => h.stopPropagation(), children: f })
    }
  ) : f;
});
...
const t1 = {
  ...
  "--elitea-assistant-header-action-bg": t.headerActionBackground,
  "--elitea-assistant-header-close-icon": t.headerCloseIcon,
  "--elitea-assistant-header-text": t.headerText,
  "--elitea-assistant-chat-bg": t.chatBackground,
  "--elitea-assistant-user-msg-bg": t.userMessageBackground,
  "--elitea-assistant-user-msg-text": t.userMessageText,
  "--elitea-assistant-user-avatar-bg": t.userAvatarBackground,
  "--elitea-assistant-user-avatar-icon": t.userAvatarIcon,
  "--elitea-assistant-bot-msg-bg": t.assistantMessageBackground,
  "--elitea-assistant-bot-msg-text": t.assistantMessageText,
  "--elitea-assistant-input-bg": t.inputBackground,
  "--elitea-assistant-input-text": t.inputText,
  "--elitea-assistant-input-border": t.inputBorder,
  "--elitea-assistant-send-btn-bg": t.sendButtonBackground,
  "--elitea-assistant-send-btn-disabled-bg": t.sendButtonDisabledBackground,
  "--elitea-assistant-send-btn-icon": t.sendButtonIcon,
  "--elitea-assistant-window-border": t.chatWindowBorder,
  "--elitea-assistant-window-shadow": t.chatWindowShadow
}), o1 = G((t, n) => {
  const {
    apiUrl: C,
    token: s,
...
Ask me anything about ELITEA or report any issues you're experiencing. I have context about your current screen and settings.`,
    ...
    theme: w = "light",
    colors: v
  } = t, [p, c] = y(!1), [u, l] = y(!1), [f, h] = y(""), [x, B] = y([]), [m, a] = y(
    () => g ? [
      {
        id: "welcome",
        role: "assistant",
  ...
  Q(
    ...
    () => ({
      ...
      close: () => c(!1),
      toggle: () => c((b) => !b),
      expandFullscreen: () => l(!0),
      collapseFullscreen: () => l(!1),
      toggleFullscreen: () => l((b) => !b),
      isOpen: () => p,
      isExpanded: () => u
    }),
    [p, u]
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      className: `elitea-assistant-container elitea-assistant-container--${L}`,
      style: k,
      children: [
        p && /* @__PURE__ */ e(
          $,
